...
- [x] 如何使用麦克风（Vue3）  :memo: [源码](/docs-2020/demo-01/device.html)  :computer: [在线演示](https://webrtc.tinywan.com/docs-2020/demo-01/device.html)  
- [x] 如何使用摄像头拍照（Vue3）  :memo: [源码](/docs-2020/demo-03/device.html)  :computer: [在线演示](https://webrtc.tinywan.com/docs-2020/demo-03/device.html)  
- [x] 如何录制音频和播放（Vue3）  :memo: [源码](/docs-2020/demo-04/device.html)  :computer: [在线演示](https://webrtc.tinywan.com/docs-2020/demo-04/device.html)  
- [x] 如何录制视频和播放（Vue3）  :memo: [源码](/docs-2020/demo-05/device.html)  :computer: [在线演示](https://webrtc.tinywan.com/docs-2020/demo-05/device.html)  
- [x] 如何录制共享屏幕和播放（Vue3）  :memo: [源码](/docs-2020/demo-06/device.html)  :computer: [在线演示](https://webrtc.tinywan.com/docs-2020/demo-06/device.html)  
